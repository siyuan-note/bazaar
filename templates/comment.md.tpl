...
- {{ if $repo.Files.Pass }}[x]{{ else }}[ ]{{ end }} Necessary Files
  ...
  - {{ if $repo.Files.IconPng.Pass }}[x] [{{ $repo.Files.IconPng.Name }}](<{{ $repo.Files.IconPng.URL }}>){{ else }}[ ] `{{ $repo.Files.IconPng.Name }}`{{ end }}
...
- {{ if $repo.Attrs.Pass }}[x]{{ else }}[ ]{{ end }} Necessary Attributes in `icon.json`
...
- {{ if $repo.Files.Pass }}[x]{{ else }}[ ]{{ end }} Necessary Files
  ...
  - {{ if $repo.Files.PreviewPng.Pass }}[x] [{{ $repo.Files.PreviewPng.Name }}](<{{ $repo.Files.PreviewPng.URL }}>){{ else }}[ ] `{{ $repo.Files.PreviewPng.Name }}`{{ end }}
  - {{ if $repo.Files.ReadmeMd.Pass }}[x] [{{ $repo.Files.ReadmeMd.Name }}](<{{ $repo.Files.ReadmeMd.URL }}>){{ else }}[ ] `{{ $repo.Files.ReadmeMd.Name }}`{{ end }}
- {{ if $repo.Attrs.Pass }}[x]{{ else }}[ ]{{ end }} Necessary Attributes in `plugin.json`
  - {{ if $repo.Attrs.Name.Pass }}[x] `name`: `{{ $repo.Attrs.Name.Value }}`{{ else }}[ ] `name`{{ end }} 
    - {{ if $repo.Attrs.Name.Unique }}[x]{{ else }}[ ]{{ end }} Unique
  - {{ if $repo.Attrs.Version.Pass }}[x] `version`: `{{ $repo.Attrs.Version.Value }}`{{ else }}[ ] `version`{{ end }} 
  - {{ if $repo.Attrs.Author.Pass }}[x] `author`: `{{ $repo.Attrs.Author.Value }}`{{ else }}[ ] `author`{{ end }} 
...
- {{ if $repo.Attrs.Pass }}[x]{{ else }}[ ]{{ end }} Necessary Attributes in `template.json`
  - {{ if $repo.Attrs.Name.Pass }}[x] `name`: `{{ $repo.Attrs.Name.Value }}`{{ else }}[ ] `name`{{ end }} 
    - {{ if $repo.Attrs.Name.Unique }}[x]{{ else }}[ ]{{ end }} Unique
  - {{ if $repo.Attrs.Version.Pass }}[x] `version`: `{{ $repo.Attrs.Version.Value }}`{{ else }}[ ] `version`{{ end }} 
  - {{ if $repo.Attrs.Author.Pass }}[x] `author`: `{{ $repo.Attrs.Author.Value }}`{{ else }}[ ] `author`{{ end }} 
...
- {{ if $repo.Attrs.Pass }}[x]{{ else }}[ ]{{ end }} Necessary Attributes in `theme.json`
  - {{ if $repo.Attrs.Name.Pass }}[x] `name`: `{{ $repo.Attrs.Name.Value }}`{{ else }}[ ] `name`{{ end }} 
    - {{ if $repo.Attrs.Name.Unique }}[x]{{ else }}[ ]{{ end }} Unique
  - {{ if $repo.Attrs.Version.Pass }}[x] `version`: `{{ $repo.Attrs.Version.Value }}`{{ else }}[ ] `version`{{ end }} 
  - {{ if $repo.Attrs.Author.Pass }}[x] `author`: `{{ $repo.Attrs.Author.Value }}`{{ else }}[ ] `author`{{ end }} 
...
- {{ if $repo.Attrs.Pass }}[x]{{ else }}[ ]{{ end }} Necessary Attributes in `widget.json`
  - {{ if $repo.Attrs.Name.Pass }}[x] `name`: `{{ $repo.Attrs.Name.Value }}`{{ else }}[ ] `name`{{ end }} 
    - {{ if $repo.Attrs.Name.Unique }}[x]{{ else }}[ ]{{ end }} Unique
  - {{ if $repo.Attrs.Version.Pass }}[x] `version`: `{{ $repo.Attrs.Version.Value }}`{{ else }}[ ] `version`{{ end }} 
  - {{ if $repo.Attrs.Author.Pass }}[x] `author`: `{{ $repo.Attrs.Author.Value }}`{{ else }}[ ] `author`{{ end }} 
